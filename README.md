This project uses a compute shader in Unity to render a 3D graph made of geometric shapes. Each cube in the graph is instanced on the GPU based on where it should lie in the mathematical function like waves, ripples, and spheres. I wrote an HLSL shader to color the cubes based on their position, which adds depth and variation across the surface.
